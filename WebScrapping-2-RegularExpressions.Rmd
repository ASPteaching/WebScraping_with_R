...
- Download the file and extract it into a folder named `regexExample1`.
- First, start getting the list of file names with list.files(), and loading the `Gapminder` dataset into R.
